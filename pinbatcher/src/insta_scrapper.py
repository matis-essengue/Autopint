...
IMAGES_PATH = ".pinbatcher/images/influs"
TOKEN = 'EAAPB3IlkXMwBOyHGj26oOElDcPWe0yvouMvtRZCfc0Q5f3UZCEjmO36WF9jP7DdXwKR5qTeSe3dgTFkT3hvKUSxsXKy9aOacqb1KkaKKPCfsJlmPFGoykD1bh1HvQliNhgu7gTDCZBx1Xrd1AWdngm4mZCUF6yrgm1be44jY3yGS0ZAlZAupv7MFHIWHysnDUxC27JtBZAmQn25pm1ZAzlGHloo4ghA4fMRw'
usernames = [
    # "spikeloveyoko",
    #  "cjay1k",
    #  "alessoyoko",
...
def download_profile(username):
    ...
    for file in os.listdir(f"{IMAGES_PATH}/{username}"):
        if not file.endswith(('jpg', 'jpeg')):
            os.remove(f"{IMAGES_PATH}/{username}/{file}")
...
def sort_pictures(username):
    dossier = f"{IMAGES_PATH}/{username}"
